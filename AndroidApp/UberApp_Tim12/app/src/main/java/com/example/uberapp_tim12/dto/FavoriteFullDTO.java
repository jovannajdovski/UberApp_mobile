...
public class FavoriteFullDTO implements Serializable {
    private Integer id;
    ...
    public FavoriteFullDTO(Integer id, String favoriteName, Set<PathDTO> locations, Set<UserRideDTO> passengers, VehicleCategory vehicleType, boolean babyTransport, boolean petTransport) {
        this.id = id;
