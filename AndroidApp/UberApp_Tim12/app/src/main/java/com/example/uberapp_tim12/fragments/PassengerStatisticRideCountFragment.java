...
public class PassengerStatisticRideCountFragment extends Fragment {
    LineChart lineGraph;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_passenger_statistic_ride_count, parent, false);
    }
