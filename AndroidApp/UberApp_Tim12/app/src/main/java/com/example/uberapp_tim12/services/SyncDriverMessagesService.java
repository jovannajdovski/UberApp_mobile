...
public class SyncDriverMessagesService extends Service {
    ExecutorService executor = Executors.newSingleThreadExecutor();
    Handler handler = new Handler(Looper.getMainLooper());

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i("REZ", "SyncDriverService onStartCommand");

        String generatedMessage = "I am a driver";
        ...
        executor.execute(() -> {
            ...
            handler.post(() -> {
                //UI Thread work here
                Intent ints = new Intent(DriverMainActivity.SYNC_DRIVER_MESSAGES);
